      ...
      <div className="container mx-auto px-4 lg:px-0 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
          ...
          <div className="flex flex-col items-start lg:pr-8">
            ...
            <p className="text-gray-400 text-sm leading-relaxed mb-8">
              Transformando negocios tradicionales en potencias digitales a través de soluciones de
              Inteligencia Artificial, automatización y desarrollo web de primer nivel.
            </p>
          ...
          {/* Links Columns */}
          <div>
            <h4 className="text-white font-bold mb-6 text-lg tracking-wide">Servicios</h4>
          ...
          <div>
            <h4 className="text-white font-bold mb-6 text-lg tracking-wide">Menú</h4>
            <ul className="flex flex-col gap-2 [&>li]:text-gray-400">
              <li>
                <a
                  href="#inicio"
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-500 text-sm">
            © {new Date().getFullYear()} SolutiAI. Todos los derechos reservados.
          </p>
          <p className="text-gray-500 text-sm flex items-center gap-1">
            Hecho con <span className="text-[var(--brand-pink)] animate-pulse">❤</span> para el
            futuro digital.
          </p>
        </div>
      </div>
