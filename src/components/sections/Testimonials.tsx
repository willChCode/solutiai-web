...
const Testimonials: React.FC = () => {
  return (
    <div id="testimonios" className="pt-22 pb-23 border-t border-white/5">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl lg:text-5xl font-extrabold mb-6 text-white tracking-tight">
            Nuestros clientes{" "}
            <span className="text-gradient">hablan por nosotros.</span>
          </h2>
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">
            Descubre cómo hemos ayudado a empresas de diversos sectores a
            escalar, automatizar y dominar el mundo digital con tecnología de
            punta.
          </p>
        </div>
