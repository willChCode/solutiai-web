        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          <div className="flex flex-col">
            ...
            <p className="text-gray-400 text-lg leading-normal mb-6 max-w-xl">
              Estamos aquí para ayudarte. Si tienes preguntas, necesitas soporte o simplemente
              quieres conocer más sobre nuestros servicios, no dudes en escribirnos o visitarnos.
              ¡Será un placer atenderte!
            </p>
            <p className="text-gray-400 text-[17px] leading-relaxed mb-12 max-w-xl flex items-center gap-2">
              Agenda una consulta gratuita por GOOGLE MEET usando nuestro panel de la derecha ➪
            </p>
            ...
            <div className="flex flex-col gap-8">
              <div className="flex items-center gap-5">
                ...
                <div>
                  <p className="text-gray-300 text-[17px]">Miguel Hidalgo 2404,</p>
          ...
          {/* Right Column: Calendly Embed (Placeholder / Professional Frame) */}
          <div className="bg-[#110813]/40 border border-white/10 rounded-[40px] overflow-hidden min-h-[600px] shadow-2xl relative group">
            <div className="absolute inset-0 bg-[var(--brand-pink)]/5 opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>
            <iframe
              src="https://calendly.com/solutiai-info/consulta-gratuita?background_color=120c10&text_color=ffffff&primary_color=f93b69"
              width="100%"
              height="100%"
              frameBorder="0"
