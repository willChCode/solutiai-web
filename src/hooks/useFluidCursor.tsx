...
const useFluidCursor = () => {
  ...
  function generateColor() {
    const brandColors = [
      { r: 0.976, g: 0.231, b: 0.412 }, // Pink (#f93b69)
      { r: 0.490, g: 0.165, b: 0.910 }, // Purple (#7d2ae8)
      { r: 0.620, g: 0.196, b: 0.651 }, // Mid (#9e32a6)
    ];

    const base = brandColors[Math.floor(Math.random() * brandColors.length)];
    const intensity = 0.25; // Slightly increased for brand pop
